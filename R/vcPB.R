#' Conditional Varying-Coefficient Disparity Decomposition Analysis for a Longitudinal Data
#'
#' The \code{cvc.pb} offers conditional Peters-Belson(PB) type of nonparametric varying-coefficient regression method which measures the disparity between a majority group
...
#' @author Sang Kyu Lee
#' @return \code{cvc.pb} returns an object of class \code{"cvc.pb"}, which is a list containing
...
#' @export
cvc.pb <-function(formula, group, data, modifier = NULL,
                 local_time = NULL,
...
#' @export
print.cvc.pb <- function(x, digits = max(3, getOption("digits") - 3), ...){
  cat("\nCall:\n\n")
